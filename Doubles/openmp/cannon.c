...
int main(int argc, char* argv[]) {
    ...
    char nuc[2];
    sprintf(nuc, "%d", NUCL);
    char *filename = malloc(strlen(nuc) + strlen("f_100omp") + 1);
    strcpy(filename, nuc);
    strcat(filename, "f_100omp");
    ...
    char *filename4 = malloc(strlen(nuc) + strlen("f_PTomp_") + 1);
    strcpy(filename4, nuc);
    strcat(filename4, "f_PTomp_");
    ...
    char *filename6 = malloc(strlen(nuc) + strlen("f_PMomp_") + 1);
    strcpy(filename6, nuc);
    strcat(filename6, "f_PMomp_");
