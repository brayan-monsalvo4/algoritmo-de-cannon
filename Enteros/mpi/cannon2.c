...
int main(int argc, char* argv[]) {
    ...
    char nuc[2];
    sprintf(nuc, "%d", NUCL);
    char *filename = malloc(strlen(nuc) + strlen("_100mpi") + 1);
    strcpy(filename, nuc);
    strcat(filename, "_100mpi");
    ...
    char *filename4 = malloc(strlen(nuc) + strlen("_PTmpi_") + 1);
    strcpy(filename4, nuc);
    strcat(filename4, "_PTmpi_");
    ...
    char *filename6 = malloc(strlen(nuc) + strlen("_PMmpi_") + 1);
    strcpy(filename6, nuc);
    strcat(filename6, "_PMmpi_");
